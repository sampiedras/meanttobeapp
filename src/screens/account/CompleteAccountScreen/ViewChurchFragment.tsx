...
} from '@/api/church/churchApi';
import {ResponseChurchEntity} from '@/api/church/entities/ChurchEntity';
import useDebounce from '@/hooks/useDebounce';

interface IViewChurchFragment {
  addChurch: boolean;
        ...
        <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Text style={styles.textFind} variant="body2">
              {getValues('church.name') || 'Find you church'}
            </Text>
          </TouchableOpacity>
        </TouchableOpacity>
        <TouchableOpacity
