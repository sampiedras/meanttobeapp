...
import {IImages} from './useActions';
import FastImage from 'react-native-fast-image';
import {ButtonDelete} from './ButtonDelete';
import { IconSelectImage, IconSelectImageTwo } from '@/assets/svg';

interface IViewPhotoFragment {
          ...
          {imagesSelected.image1 ? (
            <View style={styles.boxImage}>
              <FastImage
                ...
                <ButtonDelete onPress={() => deleteImage('image1')} isMain />
              </FastImage>
            </View>
          ) : (
            <IconSelectImage />
