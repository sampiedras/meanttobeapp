          ...
          <>
            ...
            {message.latest_reactions &&
              message.latest_reactions.length > 0 && (
                <TouchableOpacity
                  onPress={async () => {
                    const result = await handleGetReactionsAndOpenModal(
                      message?.id,
                      bottomSheetRef,
                    );
